...
namespace Exercise3.Controllers
{
    public class SupplierCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description")] SupplierCategory supplierCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description")] SupplierCategory supplierCategory)
        {
            if (ModelState.IsValid)
            {
